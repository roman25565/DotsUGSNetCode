...
namespace MainMenu.vivox
{
    ...
    public class VivoxSetup
    {
        ...
        public async void Initialize(List<VivoxUserHandler> userHandlers, Action<bool> onComplete)
        {
        ...
        public async void LoginToVivoxAsync()
        {
            ...
            options.PlayerId = AuthenticationService.Instance.PlayerId;
        ...
        public async void JoinLobbyChannel(string lobbyId, Action<bool> onComplete)
        {
            m_localLobbyId = lobbyId;
            await VivoxService.Instance.JoinEchoChannelAsync(lobbyId, ChatCapability.TextOnly);
        ...
        /// </summary>
        public async void LeaveLobbyChannel()
        {
            await VivoxService.Instance.LeaveChannelAsync(m_localLobbyId);
