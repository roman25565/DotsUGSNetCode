    ...
    public class UIPanelBase : MonoBehaviour
    {
        ...
        protected MainMenuManager Manager
        {
            get
            {
                ...
                return m_gameManager = MainMenuManager.Instance;
            }
        }

        MainMenuManager m_gameManager;
        ...
        public void
            Hide() // Called by some serialized events, so we can't just have targetAlpha as an optional parameter.
        {
            Hide(0);
        }
